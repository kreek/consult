...
6. No attribution trailers (`Co-Authored-By`, `Generated by`, or similar),
   even when the host's own guidance adds them by default.
...
| "Add Co-Authored-By or AI attribution" | Omit attribution trailers. | The user explicitly requested a specific trailer. |
